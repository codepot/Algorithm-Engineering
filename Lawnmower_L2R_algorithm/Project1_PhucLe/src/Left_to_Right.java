 ...
 * 	Given 2n alternating disks disks (light­dark), starting with light  
	...
	arranges the disks in the correct order, and outputs the arranged disks and the number of swaps 
		INPUT: 	an even integer n and a list of 2n disks of alternating   
...
public class Left_to_Right {
	...
	public static void main(String[] args) {
		...
		System.out.println("The alternating disks problem: LEFT-TO-RIGHT algorithm");
		...
		Left_to_Right left_to_Right = new Left_to_Right();		
		left_to_Right.move_disks(n, disks);
